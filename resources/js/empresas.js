        ...
        .then(data => {
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingOne${x}">
                    ...
                    <input type="text" value="${element.nombre}" class="editable${x}" disabled style="border:none;width:20%;background-color:transparent;">
                    </button>
                </h2>
                <div id="flush-collapseOne${x}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne${x}" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <div> <b>Sector:</b> <input type="text" value="${element.sector}" name="sector" class="editable${x}" disabled style="border:none;width:50%;background-color:transparent;"></div>
                        <div> <b> Email de la persona de contacto:</b><input type="text" value="${element.email_contacto}" name="email" class="editable${x}" disabled style="border:none;width:50%;background-color:transparent;"> </div>
                        <div> <b> CIF:</b> <input type="text" value="${element.cif}" name="cif" class="editable${x}" disabled style="border:none;width:50%;background-color:transparent;"> </div>
                        <div> <b> Direccion:</b> <input type="text" value="${element.direccion}" name="direccion" class="editable${x}" disabled style="border:none;width:50%;background-color:transparent;"></div>
                        <br>
