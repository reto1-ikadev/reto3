let buttonEstudianteTutor:HTMLElement = <HTMLElement> document.getElementById('btn');
buttonEstudianteTutor.addEventListener('click', llamarFiltradoEstudianteTutor);
let buttonResetEstudianteTutor:HTMLElement = <HTMLElement> document.getElementById('btnReset');
buttonResetEstudianteTutor.addEventListener('click', resetearFiltrosEstudianteTutor);
let paginaActualEstudianteTutor = 1;
let botonAnteriorEstudianteTutor:HTMLElement = <HTMLElement> document.getElementById('anterior');
let botonpaginaActualEstudianteTutor:HTMLElement = <HTMLElement>document.getElementById('paginaActual');
let botonSiguienteEstudianteTutor:HTMLElement = <HTMLElement> document.getElementById('siguiente');
...
function llamarFiltradoEstudianteTutor(evento:any) {
    paginaActualEstudianteTutor=1;
    alumnosFiltradoEstudianteTutor(evento, paginaActualEstudianteTutor);
}
function alumnosFiltradoEstudianteTutor(evento:any, pagina = 1) {
